...
try {
    ...
    Write-Host "Confira o SMTP: $portalRoot\ferramentas_lembretes\DIAGNOSTICAR_SMTP.bat"
    Write-Host 'Se o agendador ICC_Lembretes_Tarefas ja existe, habilite e execute essa tarefa novamente.'
    Write-Host 'Na primeira instalacao, use CONFIGURAR_SMTP.bat e depois INSTALAR_AGENDADOR.bat como administrador.'
    Write-Host 'No aplicativo, abra Colaboradores para cadastrar os nomes e e-mails.'
    exit 0
} catch {
